<div class="title-page">
    ...
    <p class="version">Version 27 | January 2026</p>
</div>
...
*   **Level 1: Parameters (The Numbers):** Changing the variables (Taxes, Damage, Prices). This is the easiest to do, but often the least effective. The system usually absorbs the change.
*   **Level 2: Feedback Loops (The Structure):** Changing how the system learns (New information, new constraints). This changes behavior.
*   **Level 3: The Goal (The Value Function):** Changing what the system optimizes for. This changes everything.
