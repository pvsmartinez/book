...
Imagine the history of a consumer good—say, a simple radio or a washing machine—over the last century. In the early 1900s, producing these goods might have required a network of factories employing 10,000 workers. They were the "runners" on the track of early industrial capitalism.

If we assume that these factories, driven by the market filter, become just 1% more efficient every year, the results are significant. Over 100 years, that 1% doesn't just add up; it compounds. By the end of the century, the system is nearly 3 times more efficient than when it started. 
...
In the previous chapter, we saw how a 1% improvement in efficiency, compounded over a century, can transform a system. But we didn't talk about what is being **removed** to achieve that 1%. 

In a competitive market, the "Judge" (the customer or the shareholder) filters for the most efficient iteration. If Company A has 100 maintenance workers and Company B has 90, and both provide the same service, Company B is "fitter." It has lower costs and higher margins. The Pattern selects Company B. 

Over decades, this process repeats. The system "trims the fat." It removes the "waste." 
...
The result is a systemic collapse. The city stays dark for weeks. The company, which was "fit" for the sunny days, is now helpless in the rain. The very efficiency that made them a winner has become the fragility that destroys them. 

### The Definition

We see this everywhere. We see it in supply chains that break when a single boat gets stuck in a canal. We see it in "Just-in-Time" manufacturing that grinds to a halt during a pandemic. 

**Over-Optimization** is the point in a system’s evolution where the pursuit of efficiency has removed all the buffers, leaving the system adapted to a single environment but vulnerable to any change in that environment.
...
When you put these pieces together—Iteration, Selection, and Compounding—you get a clear picture of why the world feels the way it does today. 

The world feels extreme because our **Iteration Speed** has increased. 
The world feels fragile because our **Value Functions** have become narrow, filtering for efficiency while removing buffers. 
The world feels out of control because the **Compound Effect** has taken these patterns and scaled them beyond our immediate intuition. 
