<div class="title-page">
    ...
    <p class="version">Version 24 | January 2026</p>
</div>
...
We often think of burnout as a personal failure—a lack of "grit." But if we map it, we see it is actually a rational system behaving exactly as designed.
...
To satisfy the **Survival Goal** (Pay Rent), you must increase **Work Effort**.
Increasing Work Effort drains **Energy**.
As Energy drops, you become less efficient. You have to work *longer* to get the same result.
This leaves less time for **Rest**.
Your Energy drains faster. Your Purpose fades because you are only working to survive.

Burnout isn't an event; it is the *output* of this compounding loop.

Let's look at the map.

![Mermaid Diagram](../04_Resources/images/generated/mermaid_c55a78ca1d1a5737865df647d0c6dfd1.png)

**Reading the Map:**
1.  **The Survival Loop (B1):** You need Money $\rightarrow$ You feel Anxiety $\rightarrow$ You Work $\rightarrow$ You get Money $\rightarrow$ Anxiety goes down. (This is functional).
2.  **The Burnout Loop (R1):** You Work $\rightarrow$ Energy drains $\rightarrow$ You need Rest. *But* if Anxiety is high (Rent is due), you skip Rest to Work more.
3.  **The Purpose Drain (R2):** If the work is just for survival (no Purpose), it drains you faster. As Purpose drops, work feels harder, requiring *more* Energy for the same output.

Burnout is what happens when the **Survival Loop** cannibalizes the **Energy Stock** to the point of collapse.
