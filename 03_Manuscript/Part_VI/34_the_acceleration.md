...
We currently have the largest population in human history: eight billion players in the game. That alone significantly increases the **Variance**. More people mean more mutations, more outliers, and more wild ideas.
...
Because the environment has changed, the bugs in the code (polarization, populism, short-termism) are no longer small annoyances. They compound. A small lie used to fade away; now, the algorithm amplifies it into a conspiracy theory that can topple a government in a weekend.
