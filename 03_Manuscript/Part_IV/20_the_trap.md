...
**Goal:** Explain "Lock-In" and Path Dependence. Why we get stuck with sub-optimal systems (QWERTY, Fossil Fuels) because the cost of switching is too high.

---

### 1. The Concept: Path Dependence
*   **The Question:** If the Pattern optimizes for the best, why do we use things that are clearly worse?
*   **The Answer:** Because we optimized for the *past*, and now we are stuck there.

### 2. The QWERTY Example
*   **Story:** The keyboard was designed to slow typists down (to prevent jamming).
*   **The Lock-In:** Once everyone learned it, it became the standard. Even when computers arrived (no jamming), we kept it because retraining billions of people was too expensive.
*   **Lesson:** The "Best" solution lost to the "Standard" solution.

### 3. Infrastructure Lock-In
*   **Example:** Cities built for cars.
*   **The Trap:** You can't just "switch" to public transport because the concrete is already poured. The physical reality of the past dictates the options of the future.

### 4. The Takeaway
*   **Closing Thought:** We are often trapped in "Local Maxima." To get to a higher peak, we would have to go down into the valley (pay the switching cost), and the Pattern hates going down.
