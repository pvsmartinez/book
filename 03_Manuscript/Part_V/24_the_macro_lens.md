...
**Status:** Blocking
**Goal:** Applying the framework to Society.

---

### 1. Reading the News
*   **The Skill:** When you see a headline, ask: "What incentive created this?"
*   **The Result:** Anger turns into Analysis. You stop being a puppet of the engagement algorithm.

### 2. Politics and Action
*   **The Strategy:** Don't just vote for the "Good Guy." Vote for the "Good Rule."
*   **Example:** Ranked Choice Voting (Changing the Selection Mechanism) is more important than any single candidate.
*   **Key Seeds:** [[political_selection_and_voting]].

### 3. The Bridge
*   **Closing Thought:** "We have the mindset. Now we need the checklist."
*   **Lead-in:** Chapter 18 (The Toolkit).
