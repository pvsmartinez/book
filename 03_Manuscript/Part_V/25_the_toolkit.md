...
**Status:** Blocking
**Goal:** A practical checklist for the reader.

---

### 1. The 4 Questions
*   **Q1:** What is the Value Function? (What is winning?)
*   **Q2:** What is the Iteration Speed? (How fast is it learning?)
*   **Q3:** Where is the Feedback Loop? (Who feels the pain?)
*   **Q4:** Is it Static or Dynamic? (Is it fragile?)

### 2. The Patching Tools (Nerfs, Buffs, Reworks)
*   **Nerf:** Fighting magnitude.
*   **Buff:** Shifting incentives.
*   **Rework:** Changing the logic.

### 3. The Debugging Process
*   **Step 1:** Identify the Bug (The bad outcome).
*   **Step 2:** Trace the Incentive (The bad rule).
*   **Step 3:** Propose the Patch (The new rule).
