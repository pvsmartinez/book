...
And carrots and sticks have their limits.
...
### The Second Lever: The Loop

The more powerful move is to change the flow of the system itself, not the size of the rewards, but what is actually moving through the machine and where it goes.

Start with the core loop. In game design, the core loop is the central cycle a player repeats throughout the entire game. In a classic RPG, you fight an enemy, gain experience and gold, buy better equipment, fight stronger enemies, gain more experience and gold, buy even better equipment. The loop closes back on itself. Each iteration feeds the next. This is why good games feel addictive: the feedback is immediate, the progress is visible, and the loop keeps closing.
...
### The Third Lever: The Structure

The deepest tool is changing the underlying structure of the game: the rules of what strategies are even available, the shape of the environment, who the competitors are, and what counts as winning.

This is not about the payoff. This is not about the flow. This is about the game itself.

In the early days of team-based shooters, one problem kept appearing: players would cluster at the exit of the enemy spawn point and eliminate opponents the moment they respawned. It was nearly impossible to defend against, and it made the game miserable for the losing team. The instinct might be to add a penalty for doing it, a timer, a debuff, a warning. But some developers took a different approach: they changed the map itself. Physical barriers that only the defending team could pass through made the strategy structurally impossible. Nobody was punished. Nobody was rewarded differently. The environment changed, and the behavior disappeared.

The same logic scales up. In the early 1990s, Bogotá was one of the most violent cities in the world. The standard responses were more police, higher penalties, and stricter enforcement. Mayor Antanas Mockus tried something different. He invested in the physical structure of the city: sidewalks, cycling lanes, public libraries, and lighting in neglected neighborhoods. He made public space viable to inhabit. The homicide rate dropped by roughly seventy percent over the following decade. Not because the incentives changed. Because the environment changed who used the space, and how, and who encountered whom.

Public education follows the same principle. The problem was not that children from poorer families lacked motivation to learn, or that private schools had poor teaching loops. The problem was structural: access to quality education was gated by capital. If your family could not afford it, the strategy of "get a good education" was simply not available. Public education does not improve the incentive to learn. It changes who is allowed to play the game at all.
...
Structural change is the lever with the longest reach. It is also the lever where the gap between intention and outcome is widest. When you change an incentive, the worst case is a misaligned behavior in one corner of the system. When you change the structure, you are changing the equilibria available to every player simultaneously. The ripples go further, last longer, and interact with things you were not watching. More power, more consequence. That is not a reason to avoid it. It is a reason to take it seriously.

### Pulling the Right Lever

When you are looking at a system you want to change, the first question is not "what should I do?" It is "where is the problem actually located?"

If the problem lies in the payoff, adjust the incentive. The Rested XP fix was not a weak solution. It was precisely calibrated to a framing problem, and it worked.

If the problem lies in the loop, changing rewards will not fix it. The gold economy does not fix itself because you made monsters harder to kill. You need to find what is actually flowing through the system and where it is going wrong.
