...
*   **Technique:** Diagrams. Inputs vs. Outputs.
*   **Lesson:** You cannot fix a system until you can draw it.
...
Before you can fix a system, you have to see it. Game Designers live in diagrams. They draw boxes and arrows.
*   *Input:* Player kills monster.
*   *Output:* Gold + XP.
*   *Consequence:* Player gets stronger.
*   *Side Effect:* Player gets bored of small monsters.
